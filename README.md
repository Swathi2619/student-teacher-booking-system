...
Users can register, log in, view teachers, and create booking requests.
Teachers/admins can manage schedules and view bookings easily.
The app uses Firestore Security Rules for safe read/write access.
